...
const FOOTER_LINKS = {
    ...
    Product: [
        ...
        { label: "Billing", href: "#" },
        { label: "Connect", href: "#" },
        { label: "Claim Bonus", href: "/checkout" },
    ],
    Resources: [
    ...
    return (
        <footer className="bg-[#0a1628] text-slate-400">
            <div className="mx-auto max-w-6xl px-6 pb-10 pt-16">
                ...
                {/* Divider */}
                <div className="my-10 h-px bg-slate-700/50" />

                {/* Bottom row */}
                <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
                    <p className="text-xs text-slate-500">
                        © {new Date().getFullYear()} Stripe Partner Program. All rights
                        reserved.
                    </p>
